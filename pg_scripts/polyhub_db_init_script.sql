...
INSERT INTO party_statuses (name)
VALUES ('PENDING'),
       ('APPROVED'),
...
INSERT INTO party_member_roles (name)
VALUES ('CHAIRMAN'),
       ('VICE_CHAIRMAN'),
       ('MEMBER');
...
(
    ...
    CONSTRAINT ck_party_participation_votes_count
        CHECK (votes_count IS NULL OR votes_count >= 0),

    CONSTRAINT ck_party_participation_vote_percentage
        CHECK (vote_percentage IS NULL OR vote_percentage BETWEEN 0 AND 100),

    CONSTRAINT uq_party_election_participation
